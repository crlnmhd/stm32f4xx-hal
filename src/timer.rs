            ...
            $(
                impl WithPwmCommon for $TIM {
                    ...
                    fn set_channel_polarity(c: u8, p: Polarity) {
                        ...
                        if c < Self::CH_NUMBER {
                            match p {
                                Polarity::ActiveLow => unsafe { bb::set(&tim.ccer, c*4 + 1) },
                                Polarity::ActiveHigh => unsafe { bb::clear(&tim.ccer, c*4 + 1) },
                            }
                        }
                    }
                    ...
                    fn set_nchannel_polarity(c: u8, p: Polarity) {
                        ...
                        if c < Self::CH_NUMBER {
                            match p {
                                Polarity::ActiveLow => unsafe { bb::set(&tim.ccer, c*4 + 3) },
                                Polarity::ActiveHigh => unsafe { bb::clear(&tim.ccer, c*4 + 3) },
                            }
                        }
                    }
                }
                ...
                $(
                    impl Advanced for $TIM {
                        fn enable_nchannel(c: u8, b: bool) {
                            ...
                            if c < Self::CH_NUMBER {
                                if b {
                                    unsafe { bb::set(&tim.ccer, c*4 + 2) }
                                } else {
                                    unsafe { bb::clear(&tim.ccer, c*4 + 2) }
                                }
                            }
                        }
                    }
